 ...
 * Pacientes
 *
 * @ORM\Table(name="pacientes", uniqueConstraints={@ORM\UniqueConstraint(name="idpacientes_UNIQUE", columns={"id"})}, indexes={@ORM\Index(name="fk_pacientes_acesso_idx", columns={"acesso_idacesso"})})
 * @ORM\Entity
 */
class Pacientes
{
     ...
     * @return \Acesso
     */
    public function getAcessoacesso(): \Acesso
    {
        return $this->acessoacesso;
    }

    /**
     * @param \Acesso $acessoacesso
     */
    public function setAcessoacesso(\Acesso $acessoacesso): void
    {
        $this->acessoacesso = $acessoacesso;
    }
